package com.example.a11607.mobileshop1.utils;
...
public class SpTools {
    ...
    public static void putBoolean(String key, boolean value) {
        SharedPreferences sp = MobileShopApp.getsCountext().getSharedPreferences(CONFIG_FILE_NAME, Context.MODE_PRIVATE);
